...
const CONFIG = {
    ...
    TARGET_VUS: __ENV.TARGET_VUS || 50,   // 목표 사용자 수
...
export default function () {
    ...
    // 랜덤 쿼리 선택
    const query = TEST_QUERIES[randomIntBetween(0, TEST_QUERIES.length - 1)](randomCustomerId, randomProductId, randomOrderId, randomOrderDetailProductId, randomAmount);
